...
def draw_boxes(img, bbox, identities=None, categories=None, confidences=None, names=None, colors=None):
    for i, box in enumerate(bbox):
        ...
        if not opt.nolabel:
            label = str(id) + ":" + names[cat] if confidences is None else f'{names[cat]} {confidences[i]:.2f}'
...
if __name__ == '__main__':
    ...
    # python detect_or_track.py --weights ./weights/video.pt --source street.mp4 --track --show-track --show-fps
    with torch.no_grad():
